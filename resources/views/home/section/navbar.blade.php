<nav class="navbar navbar-expand-lg menu_one" id="sticky">
    <div class="container">
        <a class="navbar-brand sticky_logo" href="index.html">
            <img src="{{ asset('assets/img/logo-w.png') }}" srcset="{{ asset('assets/img/logo-w2x.png') }}" alt="logo">
            <img src="{{ asset('assets/img/logo.png') }}" srcset="{{ asset('assets/img/logo-2x.png') }}" alt="logo">
        </a>
                    ...
                    <ul class="dropdown-menu dropdown_menu_two">
                        <li class="nav-item">
                            <a href="doc-archive.html" class="nav-link">
                                <img src="{{ asset('assets/img/tick.png') }}" alt="">
                                <div class="text">
                                    <h5>Docly</h5>
                        ...
                        <li class="nav-item">
                            <a href="doclist.html" class="nav-link">
                                <img src="{{ asset('assets/img/sheet.png') }}" alt="">
                                <div class="text">
                                    <h5>docall</h5>
                        ...
                        <li class="nav-item">
                            <a href="index.html" class="nav-link">
                                <img src="{{ asset('assets/img/gear.png') }}" alt="">
                                <div class="text">
                                    <h5>Tools</h5>
