When you install Laravel-Crod, after publishing the config, config exists in `config\laravel-crod.php` you can customize crod command, for ex:
You can set the latest repository file: UserRepository.
